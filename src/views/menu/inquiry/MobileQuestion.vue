        ...
        <div class="register">
          ...
          <div class="row solid">
            <div class="block">
              <div class="box">
                <label>
                  <input :checked="state.privacyConsent === 'Y'" type="checkbox" @click="onPrivacyConsent"/>
              ...
              <div class="box left">
                <label>
                  <input :checked="state.receiveTextReply === 'Y'" type="checkbox" @click="onReceiveTextReply"/>
